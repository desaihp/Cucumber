...
//	public void user_select_the_age_catagory(List<String> list) throws Throwable {     //for list operation
	public void user_select_the_age_catagory(DataTable table) throws Throwable {
		List<Map<String, String>> data = table.asMaps(String.class, String.class);

		System.out.println("@And-- user select the age catagory :" + data.get(0).get("Age")+"---Selected Location as: "+data.get(0).get("Location"));
		System.out.println("@And-- user select the age catagory :" + data.get(1).get("Age")+"---Selected Location as: "+data.get(1).get("Location"));

		//		System.out.println("@And-- user select the age catagory :" + list.get(1));
		//		System.out.println("@And-- user select the age catagory :" + list.get(2));
